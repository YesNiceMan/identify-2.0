...
const pngs = [
  ...
  /* 页面框架区域的大图：默认（只扫描主体内容区）会被整块跳过 */
  ['masthead-1600x400.png', 1600, 400, auroraPixel(91)],
  ['nav-bullet-640x640.png', 640, 640, gridPixel(9)],
  ['sidebar-promo-720x360.png', 720, 360, auroraPixel(204)],
  ['footer-crest-900x300.png', 900, 300, auroraPixel(777)],
  ['promo-strip-1000x320.png', 1000, 320, gridPixel(3)],
];
...
function buildPage({ dataPng, dataSvg }) {
  ...
  return ['<!doctype html>',
    ...
    '.site-nav,.sidebar,.share-links{max-width:56rem;margin:0 auto;padding:1.2rem 1.5rem;border-top:1px solid #16202b}',
    '.site-nav a{margin-right:1rem}',
    '.sidebar{display:flex;gap:1.2rem;align-items:flex-start;flex-wrap:wrap}',
    '.search-box input{width:16rem;background:#0b1016;color:#e7ecf3;border:1px solid #1e2733;padding:.4rem .6rem}',
    '</style>',
    '</head><body>',
    '<header class="site-header" style="padding:2rem 0 0">',
    '<img src="assets/logo-crest.svg" alt="IDENTIFY 标志" width="320" height="120">',
    '<img src="assets/masthead-1600x400.png" alt="页眉横幅大图" width="1600" height="400">',
    '<form class="search-box" role="search" action="/samples/lab"><input name="q" placeholder="站内搜索"><img src="assets/nav-bullet-640x640.png" alt="搜索建议图" width="640" height="640"></form>',
    '</header>',
    '<nav class="site-nav" aria-label="主导航">',
    '<a href="#main">正文</a><a href="#grid">图片</a><a href="#media">视音频</a>',
    '<img src="assets/nav-bullet-640x640.png" alt="导航装饰" width="640" height="640">',
    '</nav>',
    '<main id="main">',
    ...
    '<img src="assets/sidebar-promo-720x360.png" alt="侧栏推广图" width="720" height="360">',
    '<div><strong>侧栏订阅</strong><p>这一块在 main 之外：侧栏里的图片与文字都不属于主体内容区。</p></div>',
    '</aside>',
    '<div class="share-links">',
    '<a href="https://example.com/share?url=x">分享</a> · <a href="https://example.com/follow">关注</a>',
    '<img src="assets/promo-strip-1000x320.png" alt="分享条推广图" width="1000" height="320">',
    '</div>',
    '<footer style="padding:3rem 1.5rem;border-top:1px solid #16202b;color:#4d5765">',
    '<img src="assets/footer-crest-900x300.png" alt="页脚徽标大图" width="900" height="300">',
